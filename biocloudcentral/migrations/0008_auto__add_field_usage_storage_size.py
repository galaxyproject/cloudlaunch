...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Usage.storage_size'
        db.add_column('biocloudcentral_usage', 'storage_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Usage.storage_size'
        db.delete_column('biocloudcentral_usage', 'storage_size')
