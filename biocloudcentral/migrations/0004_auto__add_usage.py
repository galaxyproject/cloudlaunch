...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Usage'
        db.create_table('biocloudcentral_usage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('cloud_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('biocloudcentral', ['Usage'])


    def backwards(self, orm):
        
        # Deleting model 'Usage'
        db.delete_table('biocloudcentral_usage')
