...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Usage.cluster_type'
        db.add_column('biocloudcentral_usage', 'cluster_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Usage.storage_type'
        db.add_column('biocloudcentral_usage', 'storage_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Usage.cluster_type'
        db.delete_column('biocloudcentral_usage', 'cluster_type')

        # Deleting field 'Usage.storage_type'
        db.delete_column('biocloudcentral_usage', 'storage_type')
