...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djcloudbridge', '0002_auto_20171007_0736'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(blank=True, null=True, to='baselaunch.AppCategory')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deployment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='baselaunch.ApplicationDeployment')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app_version_config', to='baselaunch.ApplicationVersion')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baselaunch.ApplicationVersion'),
        ),
        migrations.AddField(
            model_name='applicationdeployment',
            name='owner',
