# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-03 00:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baselaunch.Application')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.AddField(
            ...
            name='categories',
            field=models.ManyToManyField(blank=True, to='baselaunch.Category'),
        ),
    ]
